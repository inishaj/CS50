...
void eliminate(int min)
{
    for(int i = 0; i < candidate_count; i++)
    {
        if((candidates[i].eliminated == false) && (candidates[i].votes == min))//if(candidates[i].votes == min)
        {
